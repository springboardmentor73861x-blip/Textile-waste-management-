...
// Approve / Reject
//      ↓
// Recycler/Admin gets notification
//
// ============================================================
...
export const getWasteRequestById =
  async (requestId) => {
...
export const createWasteRequest =
  async (data) => {
...
export const updateWasteRequestStatus =
  async (
    requestId,
    status
  ) => {
...
export const approveWasteRequest =
  async (requestId) => {
...
export const rejectWasteRequest =
  async (requestId) => {
...
export const startWasteRequestProcessing =
  async (
    requestId,
    machine = "",
    progress = 0
...
export const updateWasteRequestProcessing =
  async (
    requestId,
    machine,
    progress
...
export const completeWasteRequest =
  async (
    requestId,
    machine = ""
  ) => {
...
export const deleteWasteRequest =
  async (requestId) => {
...
export const getProductionWasteById =
  async (wasteId) => {
...
export const createProductionWaste =
  async (data) => {
...
export const updateProductionWaste =
  async (
    wasteId,
    data
  ) => {
...
export const deleteProductionWaste =
  async (wasteId) => {
...
export const completeSustainabilityAnalysis =
async (data) => {
...
export const sustainabilityAssessment =
async (data) => {
...
export const recyclingRecommendation =
async (data) => {
...
export const circularAnalytics =
async (data) => {
...
export const sustainabilityHealth =
async () => {
